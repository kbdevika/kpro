...
const models: TsoaRoute.Models = {
    ...
    "CouponModelType": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"users":{"dataType":"array","array":{"dataType":"string"},"required":true},"usageCount":{"dataType":"double","required":true},"usageLimit":{"dataType":"double","required":true},"maximumOrderValue":{"dataType":"string","required":true},"minimumOrderValue":{"dataType":"string","required":true},"expiryDate":{"dataType":"datetime","required":true},"startDate":{"dataType":"datetime","required":true},"discountValue":{"dataType":"string","required":true},"discountType":{"dataType":"string","required":true},"couponCode":{"dataType":"string","required":true},"id":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "ExposedCouponModel": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"values":{"dataType":"union","subSchemas":[{"ref":"CouponModelType"},{"dataType":"enum","enums":[null]}],"required":true},"discountedAmount":{"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"enum","enums":[null]}],"required":true},"applied":{"dataType":"boolean","required":true},"message":{"dataType":"string","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "_CartResponseType": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"coupon":{"ref":"ExposedCouponModel","required":true},"additionalInfo":{"dataType":"nestedObjectLiteral","nestedProperties":{"cartNote":{"dataType":"string","required":true},"savingsMessage":{"dataType":"string","required":true}},"required":true},"storeInfo":{"dataType":"nestedObjectLiteral","nestedProperties":{"storeAddress":{"dataType":"string","required":true},"storeContactPerson":{"dataType":"string","required":true},"storePhone":{"dataType":"string","required":true},"storeName":{"dataType":"string","required":true}},"required":true},"orderSummary":{"dataType":"nestedObjectLiteral","nestedProperties":{"discount":{"dataType":"double","required":true},"saved":{"dataType":"string","required":true},"deliveryCharges":{"dataType":"double","required":true},"freeDeliveryThreshold":{"dataType":"double","required":true},"deliverytime":{"dataType":"string","required":true},"total":{"dataType":"double","required":true},"subTotal":{"dataType":"double","required":true}},"required":true},"recommendedItems":{"dataType":"array","array":{"dataType":"refAlias","ref":"_CartReponseItem"},"required":true},"items":{"dataType":"array","array":{"dataType":"refAlias","ref":"_CartReponseItem"},"required":true},"cartId":{"dataType":"string","required":true},"aiStoreId":{"dataType":"string","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "_OrderResponse": {
        "dataType": "refAlias",
    ...
    "UpdateOrderRequest": {
        ...
        "properties": {
            ...
            "orderStatus": {"dataType":"string","required":true},
            "deliveryStatus": {"dataType":"string","required":true},
            "endOTP": {"dataType":"string","required":true},
            "trackingURL": {"dataType":"string","required":true},
            "riderName": {"dataType":"string","required":true},
            "riderPhone": {"dataType":"string","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router,opts?:{multer?:ReturnType<typeof multer>}) {
    ...
    const upload = opts?.multer ||  multer({"limits":{"fileSize":8388608}});
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsCartController_updateCartWithCouponCode: Record<string, TsoaRoute.ParameterSchema> = {
                body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"couponCode":{"dataType":"string","required":true},"cartId":{"dataType":"string","required":true}}},
        };
        app.post('/cart/coupon',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(CartController)),
            ...(fetchMiddlewares<RequestHandler>(CartController.prototype.updateCartWithCouponCode)),

            async function CartController_updateCartWithCouponCode(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsCartController_updateCartWithCouponCode, request, response });

                const controller = new CartController();

              await templateService.apiHandler({
                methodName: 'updateCartWithCouponCode',
                controller,
                response,
                next,
                validatedArgs,
